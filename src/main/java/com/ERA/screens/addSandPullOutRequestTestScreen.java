...
public class addSandPullOutRequestTestScreen extends Base {
	...
	@AndroidFindBy(uiAutomator = "new UiSelector().text(\"سحب من الصحراء\")")
	public MobileElement sandpullout;
	...
	@AndroidFindBy(uiAutomator = "new UiSelector().text(\"موقعي الحالي على مقربة من الطريق\")")
	public MobileElement nearTheRoad;
	public void selectNearTheRoad() {
		// TODO Auto-generated method stub
		nearTheRoad.click();
	}
	
	@AndroidFindBy(id = "com.eci.era:id/continueBtn")
	private MobileElement cofirmOption;
