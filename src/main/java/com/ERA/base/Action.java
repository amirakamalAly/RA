...
public class Action extends BaseClass implements ActionInterface {
	...
	@Override
	public boolean ClcikNormal(WebDriver driver, WebElement ele) {
		boolean flag = false;
		if (flag) {
			ele.click();
			flag = true;
	...
	@Override
	public boolean arrowdown(WebElement ele) {
		boolean flag = false;
		try {
			flag = ele.isDisplayed();

			ele.sendKeys(Keys.ARROW_DOWN);
			// ((Object) logger).info("Entered Keys.ARROW_DOWN) ");
			flag = true;
		} catch (Exception e) {
			System.out.println("Entered Keys.ARROW_DOWN");
			flag = false;
		} finally {
			if (flag) {
				System.out.println("Successfully entered value");
	...
	@Override
	public void minimizeAction(WebDriver driver) {
		boolean flag = false;
		try {
			...
			if (flag) {
				System.out.println("screen minmize  is done ");
			} else if (!flag) {
				System.out.println("screen minmize  is fail ");
			}
		}
	}
...
//			 
	...
	public String getElementText(WebDriver driver, WebElement element) {
		...
		if (flag) {
			System.out.println("Current Txt is: \"" + text + "\"");
		}
		return text;
	}
	...
	public String screenShot(WebDriver driver, String filename) {
		File source;
		String destination = "C:\\Users\\amira\\eclipse-workspace\\Automater2\\Snapshots";

		String dateName = new SimpleDateFormat("yyyyMMddhhmmss").format(new Date());
		try {
			TakesScreenshot takesScreenshot = (TakesScreenshot) driver;
			 source = takesScreenshot.getScreenshotAs(OutputType.FILE);
...
//		String newImageString = "C:\\Users\\amira\\git\\repository3\\Automater3\\ScreenShots\\" + filename + "_"
//				+ dateName + ".png";
		return destination;
	}
	...
	@Override
	public void clickarrow(WebDriver driver, WebElement ele) throws Exception {
		boolean flag = false;
		try {
			JavascriptExecutor js = (JavascriptExecutor) driver;
			...
			if (flag) {
				System.out.println("Able to click on arrow ");
			} else {
				System.out.println("Click Unable to click on arrow");
			}
		}
	}
