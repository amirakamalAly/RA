...
public interface ActionInterface {
	...
	void minimizeAction(WebDriver driver);
	void clickarrow(WebDriver driver, WebElement ele) throws Exception;
	String getElementText(WebDriver driver, WebElement element);
	boolean ClcikNormal(WebDriver driver, WebElement ele);
	boolean arrowdown(WebElement ele);
