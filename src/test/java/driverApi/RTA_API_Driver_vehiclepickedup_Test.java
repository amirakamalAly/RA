...
public class RTA_API_Driver_vehiclepickedup_Test extends Base {

	@Test(dataProvider = "access_token", priority = 1)

	public void vehiclepickedup(String Name, String MobileNumber, String RequestId, String JoborderId,
