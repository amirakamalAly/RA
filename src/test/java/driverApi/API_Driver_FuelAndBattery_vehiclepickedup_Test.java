...
public class API_Driver_FuelAndBattery_vehiclepickedup_Test extends Base {
...
////////////////////////////////Get Request///////////////////////////////////	
		...
		Response res = httpRequest.queryParam("access_token", access_token).queryParam("gx", "30.239421666666665")
				.queryParam("jobId", JoborderId).queryParam("gy", "31.483515000000004").get("/vehiclepickedup");
