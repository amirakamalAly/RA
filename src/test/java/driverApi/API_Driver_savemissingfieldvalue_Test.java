...
public class API_Driver_savemissingfieldvalue_Test extends Base {
	...
	public void savemissingfieldvalue() throws IOException {
...
////////////////////////////////Get Request///////////////////////////////////	
		...
		Response res = httpRequest.queryParam("access_token", access_token).queryParam("gx", "30.239421666666665")
				.queryParam("jobId", JoborderId).queryParam("gy", "31.483515000000004").queryParam("fieldName", "make")
				.queryParam("fieldValue", "2").get("/savemissingfieldvalue");
