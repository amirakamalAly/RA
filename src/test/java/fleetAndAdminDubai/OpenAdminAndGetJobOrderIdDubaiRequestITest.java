...
public class OpenAdminAndGetJobOrderIdDubaiRequestITest extends Base {
	WebDriver Admindriver;
	public static String JobOrderId;
	...
	public void setJobOrderId(String JobOrderId) {
		OpenAdminAndGetJobOrderIdDubaiRequestITest.JobOrderId = JobOrderId;
	}
