 ...
 *
 */
public class Admin_GetGobId_Test extends BaseClass {
...
//	}
	...
	@Test(priority = 5,dataProvider = "loginFujirahAccount", dataProviderClass = DataProviders.class)
	public void SearchWithMobileNumber(String Name, String MobileNumber, String ValidMilitaryNumber,
			String ValidDepartment, String InValidMilitaryNumber, String InValidDepartment, String InvalidName) throws Throwable {
	...
	@Test(priority = 6,dataProvider = "loginFujirahAccount", dataProviderClass = DataProviders.class)
	public void GetRequestAndJobOrderID(String Name, String MobileNumber, String ValidMilitaryNumber,
