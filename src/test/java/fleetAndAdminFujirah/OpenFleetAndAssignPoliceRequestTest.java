...
public class OpenFleetAndAssignPoliceRequestTest extends Base {
	...
	public void OpenFleetURL(String Name, String MobileNumber, String ValidMilitaryNumber, String ValidDepartment,
		...
		String fleetFujirahBaseURL = (String) new API_GetBaseURLTest().fleetBaseFujirahUrl();
		FleetMangement.get(fleetFujirahBaseURL);
		...
		String Jobid;
		Jobid = (String) new fleetAndAdminFujirah.OpenAdminAndGetJobOrderIdFujirahRequestITest().getJobOrderId();
		...
		FleetMangement.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
		FleetMangement.findElement(By.xpath("/html/body/div[2]/section/div[3]/div/div/table/tbody/tr[1]/td[12]/input")).click();
		FleetMangement.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
...
//.sendKeys("Egypt User  03");
		...
		FleetMangement.findElement(By.xpath("/html/body/div[8]/div/div/div[2]/div/form/div[5]/div[1]/span/span/input")).sendKeys(assignedriver);
		FleetMangement.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
		FleetMangement.findElement(By.xpath("/html/body/div[9]/div/div[3]/ul/li/span[1]")).click();
		FleetMangement.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
		FleetMangement.findElement(By.xpath("/html/body/div[8]/div/div/div[2]/div/form/div[8]/div[2]/input[1]")).click();
		FleetMangement.manage().timeouts().implicitlyWait(5, TimeUnit.SECONDS);
		try {
			Thread.sleep(5000);
