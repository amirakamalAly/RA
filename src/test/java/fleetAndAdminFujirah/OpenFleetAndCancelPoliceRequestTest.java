...
public class OpenFleetAndCancelPoliceRequestTest extends Base {
	...
	public void OpenFleetURL(String Name, String MobileNumber, String ValidMilitaryNumber, String ValidDepartment,
		...
		String Jobid;
		//Jobid = (String) new OpenAdminAndGetJobOrderIdDubaiRequestITest().OpenAdminURL(Name, MobileNumber,ValidMilitaryNumber, ValidDepartment, InValidMilitaryNumber, InValidDepartment, InvalidName);
